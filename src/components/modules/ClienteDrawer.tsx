...
export function ClienteDrawer({
  ...
  const campos: {
    ...
    { key: "producto", label: "Programa", items: programasElegibles(cat.productos, o.productoId), current: o.productoId, columna: "producto_id", display: "producto", displayId: "productoId" },
